...
/*[Social Desk Import Set - START]*/
import SDeskMain from './pages/sdesk/svc/SdeskMain.jsx'

import SDeskSysMgt from './pages/sdesk/svc/SDeskSysMgt.jsx'
import SDeskSysMgtDetail from './pages/sdesk/svc/components/SDeskSysMgtDetail.jsx'

/*[Social Desk Import Set - E N D]*/

/*[Gom Test Import Set - START]*/
import TestMain from './pages/test/TestMain.jsx'

/*[Gom Test Import Set - E N D]*/


const Routes = (
    <Route>
        <Route path="/" component={Layout}>
            <Redirect from="/" to="/svc/SDeskMain"/>
            <IndexRoute component={SDeskMain}/>
            
            <Redirect from="svc" to="/svc/SDeskMain"/>
            <Route path="svc">
                <Route path="SDeskMain" component={SDeskMain}/>
                <Route path="system" component={SDeskSysMgt}/>
                <Route path="system/detail/:id" component={SDeskSysMgtDetail}/>
            </Route>

            <Redirect from="gom" to="/gom/TestMain"/>
            <Route path="gom">
